...
class _InvoiceEditorScreenState extends State<InvoiceEditorScreen> {
  ...
  void _addRow() { 
    setState(() => _items.add(InvoiceItem(description: '', qty: 1, unitPrice: 0.0))); 
  }
          ...
          child: Column(children: [
            ...
            ListView.separated(
              ...
              itemBuilder: (c,i){
                ...
                return Card(child: Padding(
                  ...
                  child: Column(children: [
                    TextField(
                      controller: TextEditingController(text: it.description), 
                    ...
                    Row(children: [
                      Expanded(child: TextField(
                        controller: TextEditingController(text: it.qty.toString()), 
                        keyboardType: const TextInputType.numberWithOptions(decimal: true), 
                        onChanged: (v){ 
                          setState(() {
                            it.qty = double.tryParse(v) ?? 0;
                          }); 
                        }, 
                      ...
                      Expanded(child: TextField(
                        controller: TextEditingController(text: it.unitPrice.toString()), 
                        keyboardType: const TextInputType.numberWithOptions(decimal: true), 
                        onChanged: (v){ 
                          setState(() {
                            it.unitPrice = double.tryParse(v) ?? 0;
                          }); 
                        }, 
                      ...
                      IconButton(
                        ...
                        onPressed: _items.length > 1 ? () => _removeRow(i) : null
                      ),
                    ])
                  ])
                ));
            ...
            Row(children: [
              Expanded(child: ElevatedButton(
                onPressed: _customerCtrl.text.isNotEmpty ? _save : null, 
